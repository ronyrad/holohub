 ...
 */
enum class CopyStrategy { UNKNOWN, CONTIGUOUS, STRIDED };
...
class IMemoryCopyStrategy {
 public:
   ...
   */
  virtual StateEvent process_packet(class FrameAssemblyController& state_machine, uint8_t* payload,
   ...
   */
  virtual StateEvent execute_pending_copy(class FrameAssemblyController& state_machine) = 0;
