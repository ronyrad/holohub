...
class IMemoryCopyStrategy {
 public:
   ...
   */
  virtual StateEvent process_packet(class FrameAssemblyController& assembly_controller, uint8_t* payload,
   ...
   */
  virtual StateEvent execute_pending_copy(class FrameAssemblyController& assembly_controller) = 0;
