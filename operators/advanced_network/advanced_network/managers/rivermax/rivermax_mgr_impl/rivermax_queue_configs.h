...
class RivermaxQueueToIPOReceiverSettingsBuilder
    : public ConversionSettingsBuilder<IPOReceiverSettings, RivermaxIPOReceiverQueueConfig> {
 public:
  ...
  RivermaxQueueToIPOReceiverSettingsBuilder(
      ...
      : ConversionSettingsBuilder<IPOReceiverSettings, RivermaxIPOReceiverQueueConfig>(
...
class RivermaxQueueToRTPReceiverSettingsBuilder
    : public ConversionSettingsBuilder<RTPReceiverSettings, RivermaxRTPReceiverQueueConfig> {
 public:
  static constexpr int USECS_IN_SECOND = 1000000;
  bool send_packet_ext_info = false;
  ...
  RivermaxQueueToRTPReceiverSettingsBuilder(
      ...
      : ConversionSettingsBuilder<RTPReceiverSettings, RivermaxRTPReceiverQueueConfig>(
            source_settings, validator) {}
...
class RivermaxQueueToMediaSenderSettingsBuilder
    : public ConversionSettingsBuilder<MediaSenderSettings, RivermaxMediaSenderQueueConfig> {
 public:
  ...
  RivermaxQueueToMediaSenderSettingsBuilder(
      ...
      : ConversionSettingsBuilder<MediaSenderSettings, RivermaxMediaSenderQueueConfig>(
            source_settings, validator) {}
